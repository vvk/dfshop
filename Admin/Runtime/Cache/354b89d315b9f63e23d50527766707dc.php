...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><img src="__PUBLIC__/Images/admin_logo.gif" width="130" height="50" alt="dfshop - power for e-commerce" /></div>
  <div id="license-div" style="bgcolor:#000000;"></div>
  <div id="submenu-div">
    <ul>
      <li><a href="javascript:modalDialog('__APP__/Index/calculator', 'calculator', 340, 250)">计算器</a></li>
      <li><a href="<?php echo ($host); ?>" target="_blank">查看网店</a></li>
      <li style="border-left:none;"><a href="javascript:window.top.frames['main-frame'].document.location.reload();window.top.frames['header-frame'].document.location.reload()">刷新</a></li>
    </ul>
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
      <a href="__APP__/Index/clearCache" target="main-frame" class="fix-submenu">清除缓存</a>
      <a href="javascript:void(0)" onclick="logout()" target="_top" class="fix-submenu">退出</a>
    </div>
    <script type="text/javascript" charset="gb2312">
        function logout(){
            ...
            var url = '__APP__/Privilege/logout';
            $.post(url, '', function(data){
                window.parent.location.href='__APP__/Privilege/login';
            });
        }
...
<div id="menu-div">
  <ul>
	...
	<li><a href="__APP__/Index/main" target="main-frame">起始页</a></li>
	<li><a href="__APP__/Goods" target="main-frame">商品列表</a></li>
	<li><a href="__APP__/Order" target="main-frame">订单列表</a></li>
	<li><a href="__APP__/User/index" target="main-frame">会员列表</a></li>
	<li><a href="__APP__/Config" target="main-frame">商店设置</a></li>
